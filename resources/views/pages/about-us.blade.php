...
<div class="flex flex-col">
    ...
    <section class="relative h-[400px] w-full">
        <img src="{{ asset('assets/images/banner/banner-about-us.webp') }}" alt="About Us" class="object-cover brightness-50 w-full h-full">
        ...
        <div class="container px-4 md:px-6 mx-auto">
            <div class="grid gap-12 grid-cols-1  md:grid-cols-2">
                <div class="flex justify-center items-center h-full">
                    <img src="{{ asset('assets/images/logo/logo-w-border.webp') }}" alt="PT Intan Salsabila" class=" object-center w-[75%] h-[75%]">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <a data-fancybox data-type="pdf" class="bg-intan-secondary hover:bg-intan-primary transition-all duration-200 text-white font-bold py-2 px-4 rounded mt-4" href="{{ asset('assets/images/company-profile/company-profile-2025.pdf') }}">Lihat Profil
                        Perusahaan</a>
                </div>
            </div>
        </div>
    ...
    <img src="{{ asset('assets/images/company-profile/' . $i . '.jpg') }}" alt="{{ $i . 'Compro' }}" class="max-w-14 sm:max-w-38 object-contain mx-auto">
    </a>
</div>
@endfor
</div>
...
<section class="bg-white py-16">
    <div class="container px-4 md:px-6 mx-auto">
        ...
        <div class="legality-slider">
            <div class="flex">
                <img src="{{ asset('assets/images/certification/himpuh.png') }}" alt="Legalitas HIMPUH" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/sisko-patuh.png') }}" alt="Sisko Patuh" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/iata.png') }}" alt="IATA" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/asita.png') }}" alt="Association of Indonesia Tours & Travel Agency" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/kemenag.png') }}" alt="Kementrian Agama" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/kan-lspr.png') }}" alt="Komite Akreditasi Nasional - LSPR" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/tims-bpw.png') }}" alt="TiMS - BPW" class="max-w-14 sm:max-w-38 object-contain mx-auto">

            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/kan-lssm.png') }}" alt="Komite Akreditasi Nasional - LSSM" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
            <div class="flex">
                <img src="{{ asset('assets/images/certification/tims-qms.png') }}" alt="TiMS - QMS" class="max-w-14 sm:max-w-38 object-contain mx-auto">
            </div>
        </div>
    </div>
</section>
